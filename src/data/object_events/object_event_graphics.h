...
const u32 gObjectEventPic_Shadow[] = INCBIN_U32("graphics/object_events/pics/people/shadow.4bpp");
const u16 gObjectEventPalette_Shadow[] = INCBIN_U16("graphics/object_events/pics/people/shadow.gbapal");
